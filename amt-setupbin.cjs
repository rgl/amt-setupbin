// NB this is a modified copy of https://github.com/Ylianst/MeshCentral/blob/1.1.16/amt/amt-setupbin.js
//    see https://github.com/Ylianst/MeshCentral/issues/5655
...
var CreateAmtSetupBinStack = function () {
        ...
        for (var i in obj.records) {
            ...
            */
            ...
            for (var j in rec.variables) {
                ...
                v.type = AmtSetupBinVarIds[v.moduleid][v.varid][0];             // Set the correct type if not already connect
    ...
    // copied from https://github.com/Ylianst/MeshCentral/blob/1.1.16/common.js#L71-L76
    function hex2rstr(d) {
        var r = '', m = ('' + d).match(/../g), t;
    ...
    // copied from https://github.com/Ylianst/MeshCentral/blob/1.1.16/common.js#L78-L79
    function char2hex(i) { return (i + 0x100).toString(16).substr(-2).toUpperCase(); };

    // Convert a raw string to a hex string
    // copied from https://github.com/Ylianst/MeshCentral/blob/1.1.16/common.js#L81-L86
    ...
    // copied from https://github.com/Ylianst/MeshCentral/blob/1.1.16/amtmanager.js#L3067
    function guidToStr(g) { return g.substring(6, 8) + g.substring(4, 6) + g.substring(2, 4) + g.substring(0, 2) + '-' + g.substring(10, 12) + g.substring(8, 10) + '-' + g.substring(14, 16) + g.substring(12, 14) + '-' + g.substring(16, 20) + '-' + g.substring(20); }

    // export the variable types.
    o.AmtSetupBinVarIds = AmtSetupBinVarIds;
